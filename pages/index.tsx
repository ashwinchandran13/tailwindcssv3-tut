...
import ArbitraryProps from '../components/ArbitraryProps';
...
const index = () => {
  return (
    <div className='relative overflow-x-clip'>
      ...
      <UnderlineStyles />
      <div className='flex justify-start w-screen h-screen bg-gradient-to-br from-sky-400 to-cyan-800'>
        <h1 className='self-center text-white text-8xl mx-44 '>Arbitrary Properties</h1>
        <h5 className='self-center mt-3 text-5xl text-white underline shadow-lg decoration-teal-400'>In depth⛏️</h5>
      </div>
      <ArbitraryProps />
      <div className='flex justify-start w-screen h-screen bg-gradient-to-br from-sky-400 to-cyan-800'>
